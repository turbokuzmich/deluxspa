...
export const compositionItems = {
  ...
  almond_oil: {
    ...
    brief:
      "Масло сладкого миндаля&nbsp;&mdash; 100% чистое, натуральное масло, первого холодного отжима, без химической обработки",
    description: [
  ...
  essential_oil: {
    title: "эфирные масла",
    brief:
      "Эфирные масла&nbsp;&mdash; летучие, с&nbsp;характерным сильным запахом и&nbsp;вкусом, маслоподобные (маслянистые), нерастворимые в&nbsp;воде, в&nbsp;основном бесцветные или слабо окрашенные жидкости",
    description: [
